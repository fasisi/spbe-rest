...
/**
 * This is the model class for table "forum_thread_comment_user_action".
 *
 * @property int $id_comment
 * @property int $id_user
 * @property int $status 0=netral;1=like;2=dislike
 */
class ForumThreadCommentUserAction extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'forum_thread_comment_user_action';
    }
