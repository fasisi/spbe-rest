...
/**
 * This is the model class for table "hd_issue_discussion".
 *
 * @property int $id
 * @property int|null $linked_id_discussion
 ...
 */
class HdIssueDiscussion extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['linked_id_discussion', 'id_issue', 'id_user_create', 'id_user_delete', 'is_delete', 'is_answer', 'id_user_answer'], 'integer'],
            [['id_issue', 'judul', 'konten', 'id_user_create', 'time_create'], 'required'],
            [['konten'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'linked_id_discussion' => 'Linked Id Discussion',
            'id_issue' => 'Id Issue',
            'judul' => 'Judul',
            'konten' => 'Konten',
