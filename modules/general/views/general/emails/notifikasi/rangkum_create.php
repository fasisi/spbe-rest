...
<!-- header email -->
<p style="font-size: 30px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 36px; margin: 0;"><span style="font-size: 30px; color: #2b303a;"><strong>Topik Sedang Dirangkum</strong></span></p>
...
<p style="font-size: 15px; line-height: 1.5; text-align: center; word-break: break-word; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 23px; margin: 0;">
  ...
  Topik dengan judul "<?php echo $detail_thread["judul"]; ?>" sedang dibuat rangkumannya dengan judul "<?php echo $detail_artikel['judul'] ?>".
  </span>
</p>
</div>
</div>
